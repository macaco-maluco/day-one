...
export const STAR_LIFECYCLES = [
  [
    0.1,
    [
      SOLAR_SYSTEM_STAGES.ACCRETION_DISK,
      SOLAR_SYSTEM_STAGES.FUSION_START,
      SOLAR_SYSTEM_STAGES.MAIN_SEQUENCE,
      SOLAR_SYSTEM_STAGES.SUPERNOVA,
      SOLAR_SYSTEM_STAGES.BLACK_HOLE
    ]
  ],
  [
    0.2,
    [
      ...
      SOLAR_SYSTEM_STAGES.MAIN_SEQUENCE,
      SOLAR_SYSTEM_STAGES.SUPERNOVA,
      SOLAR_SYSTEM_STAGES.NEUTRON_STAR
    ]
  ],
  [
    0.5,
    [
      ...
      SOLAR_SYSTEM_STAGES.FUSION_START,
      SOLAR_SYSTEM_STAGES.MAIN_SEQUENCE,
      SOLAR_SYSTEM_STAGES.RED_GIANT,
      SOLAR_SYSTEM_STAGES.WHITE_DWARF
    ]
  ],
  [
    1,
    [
      ...
      SOLAR_SYSTEM_STAGES.FUSION_START,
      SOLAR_SYSTEM_STAGES.MAIN_SEQUENCE,
      SOLAR_SYSTEM_STAGES.BROWN_DWARF
    ]
  ]
]
